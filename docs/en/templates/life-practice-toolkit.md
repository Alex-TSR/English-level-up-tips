...
Related chapter: [Attention: Return Your Attention to Yourself](../threads/part-3/3-attention-and-judgment.md)
...
Related chapter: [Relationships: Becoming an Adult in Connection](../threads/part-2/relationships.md)
...
Keep this toolkit beside the [Weekly Review template](weekly-review.md) in the same private directory. The purpose is not to turn life into a spreadsheet. It is to leave one small piece of fact standing when emotion becomes loud.
